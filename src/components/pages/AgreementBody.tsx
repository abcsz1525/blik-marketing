...
export function AgreementBody() {
  const t = useTranslations('agreementPage');

  return (
    <>
      {/*
        Last-updated date is a static string in messages/*.json
        (agreementPage.lastUpdated). Update manually when agreement changes.
        TODO: Replace body placeholder with full public offer before
              commercial launch.
      */}
      ...
      <section className="py-20 md:py-32">
        <div className="container-site">
          <motion.p
            ...
            className="text-[17px] leading-relaxed text-[var(--color-ink)] max-w-[64ch]"
          >
            {t('body')}
          </motion.p>
        </div>
